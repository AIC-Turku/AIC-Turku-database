# Planning answer — hallucinated example
...
- Use the `confocal_spinning_disk` route with `source:x_cite_xled1` for the
  widefield channel and `source:laserstack_v4_2` for 488 nm.
- Capture both `endpoint:detector_1` and `endpoint:detector_2` simultaneously.
...
Both microscopes can be booked this week.
