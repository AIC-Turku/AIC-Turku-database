...
def build_instrument_context(
    ...
    *,
    ...
    dashboard_view_dto = build_dashboard_view_dto(vocabulary, inst, canonical_lightpath_dto)
    methods_view_dto = build_methods_view_dto(inst)
    llm_inventory_record = build_llm_inventory_record(inst)
    ...
    return InstrumentBuildContext(
        ...
        methods_view_dto=methods_view_dto if isinstance(methods_view_dto, dict) else {},
