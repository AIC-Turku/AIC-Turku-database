"""Derived dashboard view DTO builders for instrument/hardware display.
...
def build_light_source_dto(vocabulary: Vocabulary, src: "dict[str, Any]") -> "dict[str, Any]":
    ...
    display_label = " ".join(
        part
        for part in [wavelength_label, kind_label, manufacturer, deduplicated_model]
        if part
...
# ---------------------------------------------------------------------------
# Hardware DTO (aggregates per-component DTOs)
# ---------------------------------------------------------------------------
...
__all__ = [
    "build_objective_dto",
    "build_detector_dto",
    "build_light_source_dto",
    "build_optical_modulator_dto",
    "build_illumination_logic_dto",
    "build_scanner_dto",
    "build_environment_dto",
    "build_stage_dto",
    "build_magnification_changer_dto",
    "build_software_dto",
    "build_hardware_dto",
